...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2026 at 07:00 AM
...
INSERT INTO `part` (`part_id`, `category`, `part_name`, `description`, `unit_price`, `quantity_on_hand`, `low_stock_threshold`, `is_low_stock`, `supplier_reference`, `is_active`) VALUES
(1, 'Capacitor', 'flux capacitor', '', 4651.00, -10, 0, 0, '', 1);
