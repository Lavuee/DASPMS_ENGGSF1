...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2026 at 08:58 AM
...
INSERT INTO `customer` (`customer_id`, `first_name`, `middle_name`, `last_name`, `email`, `contact_number`, `address`, `credit_balance`, `credit_due_date`, `created_at`, `user_id`) VALUES
(1, 'John', NULL, 'Doe', 'customer@norilys.com', '09123456789', 'no address provided', 0.00, NULL, '2026-04-25 12:52:33', 4);
...
INSERT INTO `part` (`part_id`, `category`, `part_name`, `description`, `unit_price`, `quantity_on_hand`, `low_stock_threshold`, `is_low_stock`, `supplier_reference`, `is_active`, `cost_price`) VALUES
(1, 'Capacitor', 'flux capacitor', '', 4651.00, 456, 0, 0, '', 1, NULL),
(2, '', 'yig', 'Battery part', 876.00, 3, 5, 0, NULL, 1, 613.20);
...
--
ALTER TABLE `pos_item`
  MODIFY `pos_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
