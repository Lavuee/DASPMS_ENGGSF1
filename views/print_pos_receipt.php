...
$customerType = trim($sale['customer_type'] ?? '');

if ($customerType === '') {
    $customerType = !empty($sale['customer_id']) ? 'Registered' : 'Walk-in';
}
...
if (!empty($sale['customer_id'])) {
    ...
    $customerContact = trim($sale['contact_number'] ?? '');
    $customerAddress = trim($sale['customer_address'] ?? '');
    $customerLabel = 'Registered Customer';
} else {
    $customerName = trim($sale['walkin_customer_name'] ?? '');

    if ($customerName === '') {
        $customerName = 'Walk-in Customer';
    }

    $customerContact = trim($sale['walkin_contact_number'] ?? '');
    $customerAddress = trim($sale['walkin_address'] ?? '');
    $customerLabel = 'Walk-in Guest / One-time Buyer';
}
...
@media print {
    ...
    .receipt-contact-strip {
        margin: 2.2rem -10mm -12mm !important;
        padding: 1rem 10mm !important;
    ...
    <div class="receipt-wrapper" id="receiptArea">
            ...
            <div>
                ...
                <div class="receipt-meta-table">
                    ...
                    <div class="receipt-meta-row">
                        ...
                        <div class="receipt-meta-value">
                            <?php echo htmlspecialchars($customerType); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="receipt-info-grid">
            <div>
                ...
                <div class="info-line mt-3">
                    <strong>Contact:</strong> <?php echo htmlspecialchars($customerContact); ?>
                </div>

                <div class="info-line">
                    <strong>Address / Note:</strong> <?php echo htmlspecialchars($customerAddress); ?>
                </div>
            </div>
            ...
            <div class="payment-info">
                ...
                <div class="info-line">
                    <strong>Processed By:</strong> <?php echo htmlspecialchars($staffName); ?>
                </div>
            </div>
        </div>
        ...
        <div class="receipt-bottom-grid">
            <div class="receipt-note-box">
                ...
                <p class="receipt-note-text">
                    ...
                    Walk-in guest details are saved only for this POS transaction and are not automatically added to the Customers list.
                </p>
            </div>
            ...
            <table class="receipt-total-table">
                ...
                <tr>
                    <td class="label-cell">Customer Type</td>
                    <td class="amount-cell">
                        <?php echo htmlspecialchars($customerType); ?>
                    </td>
                </tr>
        ...
        <div class="receipt-contact-strip">
            ...
            <div class="contact-item">
                ...
                <span>
                    <?php echo htmlspecialchars($customerContact); ?><br>
                    Contact Number
                </span>
            </div>
